...
5. [Detection Logic](./detection-logic.md) - How anomaly detection works
6. [Alerting](./alerting.md) - Webhook setup and payload format
7. [Deployment](./deployment.md) - Docker, Kubernetes, and production setup
8. [Architecture](./architecture.md) - Internal design and components
9. [Troubleshooting](./troubleshooting.md) - Common issues and solutions
10. [API Reference](./api-reference.md) - Python API for extensions
